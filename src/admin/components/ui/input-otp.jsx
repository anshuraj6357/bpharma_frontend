...
function InputOTPSlot({ index, className, ...props }) {
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex h-9 w-9 items-center justify-center border-y border-r border-input bg-input-background text-sm transition-all outline-none first:rounded-l-md first:border-l last:rounded-r-md",
