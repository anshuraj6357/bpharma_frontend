...
return (
  <div className="max-w-xl mx-auto bg-white rounded-3xl shadow-xl p-8 space-y-8 border">
    ...
    {/* LIVE PREVIEW */}
    <div
      className={`rounded-2xl p-5 border transition-all ${remainingDue > 0
    ...
    >
      ...
      <p
        className={`text-3xl font-extrabold mt-2 ${remainingDue > 0 ? "text-yellow-700" : "text-green-700"
          }`}
      >
        ₹{remainingDue}
      </p>
...
const Row = ({ label, value, highlight, bold }) => (
  <div className="flex justify-between text-sm">
    ...
    <span
      className={`font-medium ${highlight ? "text-indigo-600" : ""} ${bold ? "font-bold text-gray-900" : ""
        }`}
    >
      {value}
    </span>
